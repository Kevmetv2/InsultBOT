...
# Author: Kevin Mehta
# Date: 3/1/19
# Purpose: detect flatmates and insult them.
# Some code was taken from a pet detection git hub repository but edited to my needs
# Import packages
import os
import cv2
import numpy as np
...
sound1 = pygame.mixer.Sound("yoursound.wav")
sound2 = pygame.mixer.Sound("yoursound.wav")
sound3 = pygame.mixer.Sound("yoursound.wav")
sound4 = pygame.mixer.Sound("yoursound.wav")
sound5 = pygame.mixer.Sound("yoursound.wav")
sound6 = pygame.mixer.Sound("yoursound.wav")
sound7 = pygame.mixer.Sound("yoursound.wav")
sound8 = pygame.mixer.Sound("yoursound.wav")
sound9 = pygame.mixer.Sound("yoursound.wav")
sound10 = pygame.mixer.Sound("yoursound.wav")
sound11 = pygame.mixer.Sound("yoursound.wav")
sound12 = pygame.mixer.Sound("yoursound.wav")
sound13 = pygame.mixer.Sound("yoursound.wav")
sound14 = pygame.mixer.Sound("yoursound.wav")
sound15 = pygame.mixer.Sound("yoursound.wav")
sound16 = pygame.mixer.Sound("yoursound.wav")
sound17 = pygame.mixer.Sound("yoursound.wav")
sound18 = pygame.mixer.Sound("yoursound.wav")
sound19 = pygame.mixer.Sound("yoursound.wav")
sound20 = pygame.mixer.Sound("yoursound.wav")
sound21 = pygame.mixer.Sound("yoursound.wav")
sound22 = pygame.mixer.Sound("yoursound.wav")
...
TL_inside = (int(IM_WIDTH), int(IM_HEIGHT))
BR_inside = (int(IM_WIDTH), int(IM_HEIGHT))
# outside box undefined
# draws entire frame as the inside box
...
def pet_detector(frame):
    ...
    # Draw boxes defining inside region.
    ...
    # If pet has been detected inside for more than 1 frames, set detected_inside flag
    if inside_counter > 1:
        detected_inside = True
        song_number = song_number + 1
        pygame.mixer.Sound.play(sound + str("song_number"))
        inside_counter = 0
        outside_counter = 0
